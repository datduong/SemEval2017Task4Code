...
def submitJob (main_dir, mode, output_file) :

  # task4B_bert_sentiment_file_notweet
  # main_dir = '/u/scratch/d/datduong/SemEval2017Task4/4B-English/'

  bert_pretrain_file = open(main_dir+output_file,"w", encoding="utf-8" )
  bert_pretrain_file.write("index\tuser_name\tuser_desc\tuser_loc\tuser_gender\ttweet_topic\ttweet_text\tlabel\n")
