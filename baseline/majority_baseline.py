...
fout = open("/u/scratch/d/datduong/SemEval2017Task4/4B-English/BertSentiment/"+folder+'/majority_baseline_by_topic_testset.tsv','w')
...
fout = open("/u/scratch/d/datduong/SemEval2017Task4/4B-English/BertSentiment/"+folder+'/topic_to_test.tsv','w')
for key,val in output_test.items():
  fout.write(key+"\n")
