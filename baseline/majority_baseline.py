...
folder = 'Base'
fin = pd.read_csv("/u/scratch/d/datduong/SemEval2017Task4/4B-English/BertSentimentNoNanUserZeroshot/"+folder+"/test.tsv",sep='\t',dtype=str)
...
fout = open("/u/scratch/d/datduong/SemEval2017Task4/4B-English/BertSentimentNoNanUserZeroshot/"+folder+'/majority_baseline_by_topic.tsv','w')
...
fout = open("/u/scratch/d/datduong/SemEval2017Task4/4B-English/BertSentimentNoNanUserZeroshot/"+folder+'/majority_baseline_by_topic_testset.tsv','w')
...
# fout = open("/u/scratch/d/datduong/SemEval2017Task4/4B-English/BertSentimentNoNanUserZeroshot/"+folder+'/topic_to_test.tsv','w')
# for key,val in output_test.items():
#   fout.write(key+"\n")
