...
conda activate tensorflow_gpuenv
for folder in full_data_mask full_data_mask_description full_data_mask_name_description_location_user_gender ; do 
  ...
  for folder_of_test_file in full_data_mask full_data_mask_name full_data_mask_user_gender full_data_mask_location full_data_mask_text full_data_mask_description full_data_mask_description_name full_data_mask_description_location full_data_mask_description_user_gender full_data_mask_name_description_location_user_gender ; do 
    for test_data_type in test_user_only ; do
