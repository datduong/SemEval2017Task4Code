...
# 'full_data_mask_name_description_location_user_gender','full_data_mask','full_data_mask_text','full_data_mask_description'
for folder in ['full_data_mask_name_description_location_user_gender','full_data_mask_user_gender','full_data_mask_text','full_data_mask_name','full_data_mask_location','full_data_mask_description','full_data_mask_description_name','full_data_mask_description_user_gender','full_data_mask_description_location']: 
