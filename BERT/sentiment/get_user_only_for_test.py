...
for folder in ['full_data_mask_name_description_location_user_gender','full_data_mask','full_data_mask_text','full_data_mask_description']: 
  ...
  test_df.to_csv('BertSentimentFilterTestLabel/'+folder+"/test_user_only.tsv",sep="\t",index=None)
