...
def get_args():
  ...
  parser.add_argument('--not_train', action='store_true',
                      help='do not train, just do test only')
  parser.add_argument('--do_test', action='store_true',
                      help='do_test only')
  parser.add_argument('--metric_option', type=str,
                      help='cosine or entailment')

  parser.add_argument('--file_extract_vec_in', type=str,
                      help='file to be converted to vec')
  parser.add_argument('--file_extract_vec_out', type=str,
                      help='output')
