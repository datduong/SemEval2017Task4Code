...
fout='task4B_bert_sentiment_file_mask'
do_filter_test_label='1'
to_skip='description+location+user_gender'
topic_to_test_file='topic_to_test_3_7'
where_save='BertSentimentFilterTestLabel37'
python3 make_bert_sentimental_data.py $main_dir $fout $to_skip
python3 make_fold.py $main_dir $fout'_description_location_user_gender.txt' $to_skip $do_filter_test_label $topic_to_test_file $where_save
...
for folder_type in full_data_mask_description_location_user_gender ; do 
